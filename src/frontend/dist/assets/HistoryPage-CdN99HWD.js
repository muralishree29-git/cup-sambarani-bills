...
import { c as createLucideIcon, d as React2, e as useComposedRefs, j as jsxRuntimeExports, r as reactExports, f as reactDomExports, a as cn, S as Skeleton, R as Receipt, B as Button, _ as __vitePreload } from "./index-0LLgf19x.js";
import { B as Badge } from "./badge-DyZ4rYC9.js";
import { c as createContextScope, a as createSlot, P as Primitive, u as useLayoutEffect2, b as useCallbackRef, d as useControllableState, e as useId, f as composeEventHandlers, g as Portal$1, h as hideOthers, i as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-BXtr0Ssn.js";
import { a as useListBills, P as Printer } from "./useBills-D9SiONgQ.js";
...
async function exportBillPDFFromHistory(bill, settings) {
  ...
  const companyName = (settings == null ? void 0 : settings.companyName) ?? "VJ Traders";
  let lY = headerTopY + 6;
  doc.setFont("helvetica", "bold");
  doc.setFontSize(13);
  ...
  const tableBody = bill.lineItems.map((it, i) => [
    String(i + 1),
    it.productName,
    it.hsn || "",
    `${Number(it.gst)}%`,
